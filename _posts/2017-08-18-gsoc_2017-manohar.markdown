...
My name is Manohar Reddy. Currently studying a 4th year Bachelors at IIIT Vadodara. I am mainly interested in distributed computing and kernel development. Holmes Processing is super fun because everything that I learnt in my course curriculum Algorithms, OS, DBMS, AI etc.. is implimented in here. Throughout this GSoC, I've learned a lot of things about Executable both PE and ELF files. Also about how a process gets loaded into memory.  BThis blog is a summary of tasks that I achieved as a part of Google Summer of Code 2017.
